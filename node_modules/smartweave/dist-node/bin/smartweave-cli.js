...
const raw_wallet = fs.readFileSync(argv.keyFile || argv.walletFile);
...
if (argv.create) {
    ...
    if (argv.contractSrc) {
        ...
        smartweave.createContract(arweave, wallet, contractSrc, initState, minFee).then((contractID) => {
        ...
        smartweave.createContractFromTx(arweave, wallet, contractSrcTx, initState, minFee).then((contractID) => {
            console.log("Contract created in TX: " + contractID);
        });
    }
}
...
if (argv.getState) {
    ...
    const contractID = argv.contract;
    smartweave.readContract(arweave, contractID).then((state) => {
        if (!state) {
