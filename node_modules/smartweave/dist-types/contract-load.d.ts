 ...
 */
export declare function loadContract(arweave: Arweave, contractID: string): Promise<{
    id: string;
    contractSrc: string;
    initState: string;
    minFee: any;
 ...
 */
export declare function createContractExecutionEnvironment(arweave: Arweave, contractSrc: string): {
    handler: ContractHandler;
    swGlobal: SmartWeaveGlobal;
};
